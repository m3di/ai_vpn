...
echo "  - Create server1.zip and server2.zip"
...
echo "  https://github.com/m3di/ai_vpn/releases/download/$NEW_VERSION/server1.zip"
echo "  https://github.com/m3di/ai_vpn/releases/download/$NEW_VERSION/server2.zip"
echo ""
